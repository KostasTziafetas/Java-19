...
public class UniversityAdministrationMenu extends JFrame {
	...
	public UniversityAdministrationMenu() {
		...
		JButton btnNewButton_5 = new JButton("Remove the student's close contact");
		...
		JButton btnNewButton_6 = new JButton("Remove the staff member's close contact");
		...
		Image img9 = new ImageIcon(this.getClass().getResource("left-arrow (1).png")).getImage();
		btnBackButton.setIcon(new ImageIcon(img9));
		btnBackButton.setFont(new Font("Tahoma", Font.BOLD, 24));
		contentPane.add(btnBackButton);
		
		Image img3 = new ImageIcon(this.getClass().getResource("close (1).png")).getImage();
		btnExitButton1.setIcon(new ImageIcon(img3));
		btnExitButton1.setFont(new Font("Tahoma", Font.BOLD, 24));
		contentPane.add(btnExitButton1);
		
		JLabel lblImage2 = new JLabel("");
		Image img2 = new ImageIcon(this.getClass().getResource("covid19.png")).getImage();
