...
public class StaffCloseCon extends JFrame {
	...
	public StaffCloseCon() {
		...
		Image img13 = new ImageIcon(this.getClass().getResource("breathing (2).png")).getImage();
		...
		Image img9 = new ImageIcon(this.getClass().getResource("cough.png")).getImage();
		...
		Image img20 = new ImageIcon(this.getClass().getResource("dizziness.png")).getImage();
