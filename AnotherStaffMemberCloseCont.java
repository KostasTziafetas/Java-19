...
public class AnotherStaffMemberCloseCont extends JFrame {
	...
	public AnotherStaffMemberCloseCont() {
		...
		Image img14 = new ImageIcon(this.getClass().getResource("Healthcare-Virus-icon.png")).getImage();
		lblImage14.setIcon(new ImageIcon(img14));
		lblImage14.setBounds(321, 156, 96, 96);
		contentPane.add(lblImage14);
		
		JLabel lblImage2 = new JLabel("");
		Image img2 = new ImageIcon(this.getClass().getResource("Healthcare-Virus-icon.png")).getImage();
		...
		Image img4 = new ImageIcon(this.getClass().getResource("Healthcare-Virus-icon.png")).getImage();
