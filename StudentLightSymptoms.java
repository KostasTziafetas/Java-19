...
public class StudentLightSymptoms extends JFrame {
	...
	public StudentLightSymptoms() {
		...
		Image img12 = new ImageIcon(this.getClass().getResource("headache.png")).getImage();
		...
		Image img11 = new ImageIcon(this.getClass().getResource("vomiting.png")).getImage();
		...
		Image img13 = new ImageIcon(this.getClass().getResource("cold.png")).getImage();
		lblImage13.setIcon(new ImageIcon(img13));
		lblImage13.setBounds(200, 143, 64, 64);
		contentPane.add(lblImage13);
		Image img14 = new ImageIcon(this.getClass().getResource("stomach-flu.png")).getImage();
		
		JLabel lblImage16 = new JLabel("");
		Image img16 = new ImageIcon(this.getClass().getResource("fatigue.png")).getImage();
		...
		Image img17 = new ImageIcon(this.getClass().getResource("diarrhea.png")).getImage();
		...
		Image img8 = new ImageIcon(this.getClass().getResource("diarrhea (1).png")).getImage();
