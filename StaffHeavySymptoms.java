...
public class StaffHeavySymptoms extends JFrame {
	...
	public StaffHeavySymptoms() {
		...
		JLabel lblNewLabel = new JLabel("You should stay in Quarantine for 14 days from" + StaffCloseCon.dateclosecont + " and do the Covid-19 test");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel.setBounds(12, 83, 696, 58);
