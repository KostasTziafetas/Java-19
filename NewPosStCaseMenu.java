...
public class NewPosStCaseMenu extends JFrame {
	...
	public NewPosStCaseMenu() {
		...
		Image img14 = new ImageIcon(this.getClass().getResource("covid-19.png")).getImage();
		lblImage14.setIcon(new ImageIcon(img14));
		lblImage14.setBounds(932, 297, 96, 96);
		contentPane.add(lblImage14);
		
		JLabel lblImage2 = new JLabel("");
		Image img2 = new ImageIcon(this.getClass().getResource("covid-19.png")).getImage();
		...
		Image img5 = new ImageIcon(this.getClass().getResource("covid-19.png")).getImage();
