...
public class GraphicalUserInterface {
	...
	private void initialize() {
		...
		btnNewButton.setBounds(529, 528, 207, 78);
		...
		Image img6 = new ImageIcon(this.getClass().getResource("viruss.png")).getImage();
		lblImage6.setIcon(new ImageIcon(img6));
		lblImage6.setBounds(1036, 54, 176, 148);
